...
test('normalizeRunSeq falls back to 0-0 for invalid input', () => {
...
test('compareRunSeq orders by timestamp then sub-sequence', () => {
...
test('hasOngoingRunChunks detects pending message chunks', () => {
...
test('resolveRunResumeAfterSeq picks the correct resume point', () => {
  const emptyThreadState = {
    activeRunId: 'run-1',
    runLastSeq: '1700000000005-0',
    onGoingConv: { msgChunks: {} }
