...
export const TOOL_ICON_MAP = {
  ...
  read_file: FileText,
  replace: FilePen,
  research_add_project_assets: Folder,
  research_create_milestone: CheckSquare,
  research_create_project: Database,
  research_create_synthesis: FileText,
  research_create_task: CheckSquare,
  research_delete_milestone: CheckSquare,
  research_delete_project: Database,
  research_delete_task: CheckSquare,
  research_export_synthesis: FolderOutput,
  research_get_context: Database,
  research_get_project: Database,
  research_get_project_plan: CheckSquare,
  research_get_search_run: RefreshCw,
  research_get_synthesis: FileText,
  research_link_asset_to_plan: Network,
  research_list_project_asset_candidates: Folder,
  research_list_project_assets: Folder,
  research_list_projects: Database,
  research_regenerate_synthesis: FileText,
  research_remove_project_asset: Folder,
  research_search_papers: FolderSearch,
  research_set_project_status: Database,
  research_unlink_asset_from_plan: Network,
  research_update_milestone: CheckSquare,
  research_update_project: Database,
  research_update_task: CheckSquare,
