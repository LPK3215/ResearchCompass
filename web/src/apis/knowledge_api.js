...
export const evaluationApi = {
  ...
  downloadExternalBaselineTemplate: async (kbId, datasetId) =>
    apiAdminGet(`/api/evaluation/databases/${kbId}/datasets/${datasetId}/baseline-template`, {}, 'blob'),
  ...
  createExperiment: async (kbId, params) => {
    return apiAdminPost(`/api/evaluation/databases/${kbId}/experiments`, params)
  },

  listExperiments: async (kbId) => {
    return apiAdminGet(`/api/evaluation/databases/${kbId}/experiments`)
  },

  getExperiment: async (kbId, experimentId) => {
    return apiAdminGet(`/api/evaluation/databases/${kbId}/experiments/${experimentId}`)
  },

  deleteExperiment: async (kbId, experimentId) => {
    return apiAdminDelete(`/api/evaluation/databases/${kbId}/experiments/${experimentId}`)
  }
}
