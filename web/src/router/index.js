...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/research-study',
      name: 'ResearchUserStudy',
      component: () => import('@/views/ResearchUserStudyView.vue'),
      meta: { requiresAuth: false }
    },
    {
      path: '/agent',
      ...
      children: [
        {
          ...
          component: () => import('../views/ResearchCompassView.vue'),
          meta: { keepAlive: false, requiresAuth: true }
        },
        {
          path: ':kbId/papers/:paperId/analysis',
          name: 'ResearchPaperAnalysis',
          component: () => import('../views/ResearchPaperAnalysisView.vue'),
          meta: { keepAlive: false, requiresAuth: true }
        }
      ]
    },
