...
> ResearchCompass 基于开源智能体框架 Yuxi 二次开发，本测试规范同时覆盖框架通用能力与科研业务扩展。

本文档用于指导 ResearchCompass 后续如何创建测试文件、修改测试文件，以及如何验证项目功能。目标是务实、稳定、可执行，不追求过度设计。
...
对当前 ResearchCompass 来说，这就是最务实、也最容易持续执行的测试标准。
