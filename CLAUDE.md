...
ResearchCompass（科研罗盘）是本仓库作者在开源智能体框架 Yuxi 之上二次开发的科研智能体平台。Yuxi 是一个基于大模型的智能知识库与知识图谱智能体开发平台，融合了 RAG 与知识图谱技术，基于 LangGraph v1 + Vue.js + FastAPI + LightRAG 架构构建，并提供 Docker Compose 管理与热重载开发；ResearchCompass 在该通用底座之上实现科研业务流程、领域工具与证据管理能力。
